export const UPPER_LEDS = [
    { n: 1, name: "Dispense Transport", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 2, name: "Upper Transport — Front Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 3, name: "Upper Transport — Back Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 4, name: "Escrow Transport", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 5, name: "Bridge / Centralisation", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 6, name: "Cash-in Transport — Front Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 7, name: "Cash-in Transport — Back Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
...
export const LOWER_LEDS = [
    { n: 10, name: "Lower Transport — Front Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto o cassette ausente" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
    { n: 11, name: "Lower Transport — Back Latch", states: [{ cls: "rs", label: "ROJO SÓLIDO", desc: "Latch abierto o cassette ausente" }, { cls: "rf", label: "ROJO FLASH", desc: "Atasco o falla" }, { cls: "gs", label: "VERDE", desc: "Saludable" }] },
